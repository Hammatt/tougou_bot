...
use tougou_bot::commands::{
    jisho::JishoCommand, pic::PicCommand, ping::PingCommand, status::StatusCommand, tag::TagCommand, vndb::VNDBCommand,
};
...
fn main() {
    ...
    let vndb_org_repository = Box::new(vndb_repository::vndb_org_repository::VNDBOrgRepository::default());
